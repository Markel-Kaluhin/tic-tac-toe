...
class User(Base):
    ...
    def validate_first_name(self, key: str, value: str) -> Optional[str]:
        if len(value) > 0:
    ...
    @validates("last_name")
    def validate_last_name(self, key: str, value: str) -> Optional[str]:
        if len(value) > 0:
            if not value.istitle():
    ...
    @validates("email")
    def validate_email(self, key: str, value: str) -> Optional[str]:
        if len(value) > 0:
    ...
    @validates("nickname")
    def validate_nickname(self, key: str, value: str) -> Optional[str]:
        if len(value) == 0:
    ...
    @validates("age")
    def validate_age(self, key: str, value: str) -> Optional[int]:
        if len(value) > 0:
